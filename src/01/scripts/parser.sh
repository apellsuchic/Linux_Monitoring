...
if [[ $# != 6 ]]; then
    ...
    echo "Необходимо ввести абсолютный путь!"
elif [[ ! -d $1 ]]; then
    echo "Это не папка!"
    ...
    echo "5 аргумент должен быть в формате имя.расширение: Имя(не более 7 букв), Расш.(не более 3 букв) (например, photo.png)"
elif [[ ! $6 =~ $regex5 ]]; then
    echo "6 аргумент должен быть в формате: 'число'kb' Число(не более 100)"
else
